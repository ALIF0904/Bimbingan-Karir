<div class="drawer-side is-drawer-close:overflow-visible">
    ...
    <div class="flex min-h-full flex-col bg-base-200
        ...
        <div class="flex items-center justify-center p-4">
            <img src="{{ asset('storage/logo_bengkod.svg') }}" class="w-35 h-auto transition-all duration-300" alt="Logo">
        </div>
        ...
        <ul class="menu w-full grow gap-1 px-2">
            ...
            <li class="{{ request()->routeIs('dashboard') ? 'bg-gray-200 rounded-lg' : '' }}">
                <a href="{{ route('dashboard') }}"
                    ...
                    <span class="is-drawer-close:hidden text-lg">Dashboard</span>
                </a>
            </li>
            ...
            <li class="{{ request()->routeIs('categories.*') ? 'bg-gray-200 rounded-lg' : '' }}">
                <a href="{{ route('categories.index') }}"
                    ...
                    <span class="is-drawer-close:hidden text-lg">Manajemen Kategori</span>
                </a>
            </li>
            ...
            <li class="{{ request()->routeIs('events.*') ? 'bg-gray-200 rounded-lg' : '' }}">
                <a href="{{ route('events.index') }}"
                    ...
                    <span class="is-drawer-close:hidden text-lg">Manajemen Event</span>
                </a>
            </li>
            ...
            <li class="{{ request()->routeIs('transactions.*') ? 'bg-gray-200 rounded-lg' : '' }}">
                <a href="{{ route('transactions.index') }}"
                    ...
                    <span class="is-drawer-close:hidden text-lg">History Pembelian</span>
                </a>
            </li>
        </ul>
        ...
        <div class="p-4">
            <form method="POST" action="{{ route('logout') }}">
                ...
                <button type="submit"
                    ...
                    <span class="is-drawer-close:hidden text-lg">Logout</span>
                </button>
            </form>
        </div>
